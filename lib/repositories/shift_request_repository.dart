...
class ShiftRequestRepository extends ShiftRequestRepositoryInterface {
  ShiftRequestRepository({@required this.firestore, @required this.userRepo})
  ...
  static const String shiftsCollectionName = 'shift-requests';
